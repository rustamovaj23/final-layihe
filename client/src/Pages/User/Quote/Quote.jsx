  ...
  return (
    <div className='all-quote-page'>
        ...
        <div className="quote-left">
          ...
          <div className="quote-left-second">
          ...
          <div className="quote-left-fifth">
        ...
        <div className="quote-right">
          ...
          <div className="quote-right-first">
            <h5>CATEGORIES</h5>
          </div>
          <div className="quote-right-second">
