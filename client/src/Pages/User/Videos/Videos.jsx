...
<p style={{"fontFamily":"Playfair Display", "fontSize":"40px"}}>Making Bouquets</p>
          </div>
          <div className="videos-left-second">
          <div className="videos-left-forth">
          ...
          <div className="videos-left-third">
          ...
          <div className="videos-left-fifth">
